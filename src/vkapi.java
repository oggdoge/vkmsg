...
public class vkapi {
    ...
    private String email = "79998129409";//тут должен быть прописан email
    private String pass = "northdog1290";//тут должен быть прописан пароль
...
// Просто спарсим его сплитами
    ...
    public String getNewMessage() throws ClientProtocolException, IOException, NoSuchAlgorithmException, URISyntaxException {
        ...
        return line;//Ранее описанный код получения списка сообщений
